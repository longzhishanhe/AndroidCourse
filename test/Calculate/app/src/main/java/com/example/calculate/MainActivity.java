...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        //根据按钮发生对应事件
        switch(v.getId()){
            //点击删除按钮，如果结果框字符串大于1，则删除末尾字符，否则字符置为0
            case R.id.btn_del:
                if(str.length()>1){
            ...
            case R.id.btn_clear:
                ...
                text.setText(str);
                break;
            //点击数字按钮，如果结果框字符串为0，则置为对应数字，否则字符串末尾追加对应的字符
            case R.id.btn_0:
                if (str.equals("0")){
                    str="0";
                }
            ...
            case R.id.btn_9:
                ...
                text.setText(str);
                break;
            //点击小数点、+-*/按钮，如果结果框原字符串末尾为小数点、+-*/，则使用Toast报错，否则在字符串末尾追加对应字符
            case R.id.btn_p:
                ...
                if(str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'){
                    ...
                    if (ero.equals("no error")) {
                        ...
                        if (re.contains("Infinity")) {
                            Toast.makeText(MainActivity.this, "0不能作为约数", Toast.LENGTH_SHORT).show();
                            text.setText("0");
                        } else {
                            text.setText(re);
                        }
            ...
            case R.id.btn_sin:
                ...
                sinn=Math.sin(sinn);
                String sinn1=String.format("%.9f",sinn);
                text.setText(sinn1);
                break;
                //计算cos
            case R.id.btn_cos:
                ...
                coss=Math.cos(coss);
                String coss1=String.format("%.9f",coss);
                text.setText(coss1);
                break;
                //正负转变
            case R.id.btn_PandM:
